class ContactsController < ApplicationController
  ...
  def index
    ...
    @clientContacts = Contact.where( client_id: params[:client_id]).all.order(id: :asc)
  end
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:first_name, :last_name, :phone_number, :phone_ext, :email, :title, :client_id, :cell_number)
    end
end
